...
const Footer = () => {
    ...
    return (
        <div className='container text-center mt-5 pb-1 pt-2 bg-dark text-white'>

            <div className='row '>

                <div className='col-md-6' >Follow us: <FaFacebookSquare></FaFacebookSquare> <FaTwitterSquare></FaTwitterSquare> <FaYoutubeSquare></FaYoutubeSquare>
